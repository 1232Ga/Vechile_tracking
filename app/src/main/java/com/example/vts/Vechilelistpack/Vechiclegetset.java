...
public class Vechiclegetset {
    ...
    @Expose
    private List<DriverManagementItem> driverManagementItems = null;
    @SerializedName("DriverManagementItem")
    @Expose
    private Object driverManagementItem;
    @SerializedName("VehicleOwnerManagementItems")
    @Expose
    private List<VehicleOwnerManagementItem> vehicleOwnerManagementItems = null;
    ...
    public List<DriverManagementItem> getDriverManagementItems() {
        return driverManagementItems;
    }

    public void setDriverManagementItems(List<DriverManagementItem> driverManagementItems) {
    ...
    public List<VehicleOwnerManagementItem> getVehicleOwnerManagementItems() {
        return vehicleOwnerManagementItems;
    }

    public void setVehicleOwnerManagementItems(List<VehicleOwnerManagementItem> vehicleOwnerManagementItems) {
