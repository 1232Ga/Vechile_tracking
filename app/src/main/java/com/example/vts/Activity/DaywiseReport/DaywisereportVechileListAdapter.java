...
public  class DaywisereportVechileListAdapter extends RecyclerView.Adapter<DaywisereportVechileListAdapter.UsersViewHolder> {

    Context context;
    List<CategoryTwoField> userListResponseData;

    public DaywisereportVechileListAdapter(Context context, List<CategoryTwoField> userListResponseData) {
    ...
    public UsersViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        DaywisereportVechileListAdapter.UsersViewHolder viewHolder = new DaywisereportVechileListAdapter.UsersViewHolder(listItem);
        return viewHolder;
    }
