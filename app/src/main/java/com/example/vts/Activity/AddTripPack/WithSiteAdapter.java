...
public  class WithSiteAdapter extends RecyclerView.Adapter<WithSiteAdapter.UsersViewHolder> implements Filterable {

    Context context;
    List<Eravanaidgetset> userListResponseData;
    List<Eravanaidgetset> FullList;
    public WithSiteAdapter(Context context, List<Eravanaidgetset> userListResponseData) {
    ...
    public UsersViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        WithSiteAdapter.UsersViewHolder viewHolder = new WithSiteAdapter.UsersViewHolder(listItem);
        return viewHolder;
    }
