...
public  class IdlereportVechileListAdapter extends RecyclerView.Adapter<IdlereportVechileListAdapter.UsersViewHolder> {

    Context context;
    List<com.example.vts.Activity.IdleReport.CategoryTwoField> userListResponseData;

    public IdlereportVechileListAdapter(Context context, List<com.example.vts.Activity.IdleReport.CategoryTwoField> userListResponseData) {
    ...
    public UsersViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        IdlereportVechileListAdapter.UsersViewHolder viewHolder = new IdlereportVechileListAdapter.UsersViewHolder(listItem);
        return viewHolder;
    }
