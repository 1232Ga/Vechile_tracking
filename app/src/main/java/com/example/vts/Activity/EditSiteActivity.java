...
import com.example.vts.Activity.Addsitr.EditParameter;
import com.example.vts.Activity.Addsitr.EditSiteInterface;
...
public class EditSiteActivity extends AppCompatActivity implements OnMapReadyCallback {
String Siteid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Login=findViewById(R.id.changeeditsite);
        ...
        sourcename.setAdapter(new PlacesAutoCompleteAdapter(EditSiteActivity.this, R.layout.autocomplete_list_item));
...
//                                    address.setText(formatted_address);
                                    ...
                                    if (location != null || location.equals("")) {
                                        Geocoder geocoder = new Geocoder(EditSiteActivity.this,Locale.getDefault());
                                        try {
...
//                                     , , pincode, ,orgnizationname
    ...
    private void category() {
        final ProgressDialog progressDialog = new ProgressDialog(EditSiteActivity.this);
        ...
        AddDeviceApi.getRetrofitInstance(context).create(EditSiteInterface.class).registration2(prameter).enqueue(new Callback<AddSitegetset>() {
            @Override
            public void onResponse(Call<AddSitegetset> call, Response<AddSitegetset> response) {
                progressDialog.dismiss();
                if(response.body().getSuccess()==false){
                    Toast.makeText(EditSiteActivity.this, response.body().getErrorMessage(), Toast.LENGTH_SHORT).show();
                }else if( response.body().getSuccess()==true){
                    Intent intent=new Intent(EditSiteActivity.this,SiteActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    Toast.makeText(EditSiteActivity.this, response.body().getSuccessMessage(), Toast.LENGTH_SHORT).show();
                }
            }
